...
export const resumeProjectCommand: ResumeCommand = {
  ...
  process: (currentId: number) => {
    return [
      ...
      addAPromptObj(
        currentId + 5,
        'Serenade Softworks - Currently working with several people to build a point-and-click style adventure game. My job is main engineer, and game director. I coordinate with everyone to help hit deadlines and milestones. Built using Unity.',
        true,
      ),
      addAPromptObj(
        currentId + 6,
        'No current public GitHub repo for this, but you can check out our game submission for the 2023 Adventure Game Jam to get an idea of what it will be!',
        true,
        'https://kitsune-23.itch.io/the-secret-ingredient',
      ),
      addAPromptObj(
        currentId + 6,
        'Frozenspade.TV - Website built for the world record holding speedrunner and Twitch streamer "Frozenspade". Built utilizing react. Integrates with the SpeedRun.Com api to pull the latest speed runs and records.',
